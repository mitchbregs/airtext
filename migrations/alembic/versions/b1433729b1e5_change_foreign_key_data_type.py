...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['member_id'], ['members.id'], name='proxy_members_member_id_fkey'),
    sa.ForeignKeyConstraint(['proxy_id'], ['proxies.id'], name='proxy_members_proxy_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='proxy_members_pkey'),
    sa.UniqueConstraint('proxy_id', 'member_id', name='proxy_members_proxy_id_member_id_key')
    )
    ...
    sa.Column('created_on', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['contact_id'], ['contacts.id'], name='member_contacts_contact_id_fkey'),
    sa.ForeignKeyConstraint(['member_id'], ['members.id'], name='member_contacts_member_id_fkey'),
    ...
    sa.Column('member_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('created_on', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['member_id'], ['members.id'], name='campaigns_member_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['campaign_id'], ['campaigns.id'], name='compaign_contacts_campaign_id_fkey'),
    sa.ForeignKeyConstraint(['contact_id'], ['contacts.id'], name='compaign_contacts_contact_id_fkey'),
